...
export default function MockExamSolver({ queue, setQueue, index, setIndex, onGrade, queueLabel, onFinish }) {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      {isSolving ? (
        <div className="grid h-[calc(100vh-140px)] grid-cols-1 gap-4 lg:grid-cols-2">
          <section className="relative flex min-w-0 flex-col overflow-hidden rounded-3xl border-4 border-dashed border-amber-200 bg-amber-50/40 p-3 shadow-lg shadow-amber-100/60">
          ...
          <section className="flex min-w-0 flex-1 flex-col gap-3">
            ...
            <button
              ...
              onClick={goToNext}
              disabled={submitting}
              className="h-24 w-full shrink-0 rounded-3xl bg-gradient-to-r from-rose-400 to-amber-400 px-2 text-lg font-extrabold text-white shadow-lg shadow-rose-200 hover:from-rose-500 hover:to-amber-500 disabled:cursor-wait disabled:opacity-60 md:text-2xl"
            >
